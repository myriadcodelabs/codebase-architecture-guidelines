...
Use these import direction and isolation rules to prevent cyclic architecture and keep shell, feature, orchestration, state, and platform concerns isolated.
...
Flow code must consume these capabilities through ports/contracts.
...
- No cross-imports between sibling features unless through shared contracts.
